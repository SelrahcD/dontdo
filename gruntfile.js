module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		options: {
			...
			// CSS settings
			css: {
				base: 'public/assets/css',			 				// Base path to your CSS folder
				files: ['public/assets/css/style_one.css','public/assets/css/style_two.css','public/assets/css/less.css'],							// CSS files in order you'd like them concatenated and minified
				concat: '<%= options.css.base %>/concat.css',	// Name of the concatenated CSS file
				min: '<%= options.css.base %>/style.min.css'	// Name of the minified CSS file
			},

			// JavaScript settings
			js: {
				base: 'public/assets/js',							// Base path to you JS folder
				files: ['public/assets/js/script_one.js','public/assets/js/script_two.js'],							// JavaScript files in order you'd like them concatenated and minified
				concat: '<%= options.js.base %>/concat.js',		// Name of the concatenated JavaScript file
				min: '<%= options.js.base %>/script.min.js'		// Name of the minified JavaScript file
			},

			// LESS Settings
			less: {
				base: 'public/assets/less',							// Base path to you LESS folder
				file: 'public/assets/less/main.less',							// LESS file (ideally, one file which contains imports)
				compiled: '<%= options.css.base %>/less.css'	// Name of the compiled LESS file
			},

			// SASS Settings
			sass: {
				base: 'public/assets/sass',							// Base path to you SASS folder
				file: 'public/assets/sass/main.sass',							// SASS file (ideally, one file which contains imports)
				compiled: '<%= options.css.base %>/sass.css'	// Name of the compiled SASS file
			},

			// STYLUS Settings
			stylus: {
				base: 'public/assets/stylus',							// Base path to you STYLUS folder
				file: 'public/assets/stylus/main.stylus',							// STYLUS file (ideally, one file which contains imports)
	...
	// Register tasks
	grunt.registerTask('default', ['clean:all', 'sass', 'phpunit',  'concat:css', 'concat:js', 'cssmin', 'uglify', 'clean:concat']); // Default task
}